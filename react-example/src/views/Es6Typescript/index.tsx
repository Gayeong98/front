...
export default function Es6Typescript() {
    ...
    //? 데이터 타입이 지정된 변수는 필수적으로 값이 포함되어 있어야 한다
    ...
    //# 5. if 
    //? if문의 조건
    //? ES6와 TS에서는 false, '', 0, {}, [], null, undefined 를 모두 false로 받고 나머지는 전부 true
    ...
    //# 6. for
    //? foreach 반복문
    //? Java -> for(요소의 데이터타입 변수명 : 반복해서 접근할 배열) {}
    ...
    //# interface
    //? TS : interface를 데이터 타입 형태로 주로 사용
    interface IExample {
        a : string;
        b: number;
        c: boolean;
    ...
    //? Spread 연산자
    //? ...객체
    //? 1. 비구조화 할당에 쓰일 대는 직접 뽑은 요소를 제외한 나머지 요소를 하나의 묶음으로 묶어 줌
